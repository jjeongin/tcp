...
void resend_packets(int sig)
{
    if (sig == SIGALRM)
    {
        ...
        if(sendto(sockfd, sndpkt_window[0], TCP_HDR_SIZE + get_data_size(sndpkt_window[0]), 0, 
    ...
    while (1)
    {
        ...
        do {
            ...
            do
            {
                ...
                // send_base = recvpkt->hdr.ackno; // reinitialize send_base to previous next_seqno
